        ...
        <div className='grid grid-rows-10 h-full'>
                <div className='flex items-center justify-between'>
                    ...
                    <div className="updatedetails flex flex-row-reverse gap-6">
                      <button className='flex justify-center border border-red-600 py-3 rounded-xl text-red-600 px-4 font-semibold hover:bg-red-600 hover:text-white text-sm '>Delete Student</button>
