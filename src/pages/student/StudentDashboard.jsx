                    ...
                    <div className="row-span-6 overflow-y-scroll scrollbar-hide mt-4 max-h-48">
                      {notifications.length > 0 ? (
                        notifications.map((note, index) => (
                          <div
                            key={index}
                            className="flex flex-col border-b border-zinc-200 py-2 gap-4 justify-between"
                          >
                    ...
                    <div className="row-span-2 border border-zinc-200 bg-white rounded-xl p-4 h-full flex items-center">
                      <div className="flex justify-between w-full">
                        ...
                        <div className="flex items-center">
                          <Link
                            to="/student-profile"
                            className="px-4 py-2 bg-sky-700 text-white rounded-lg hover:bg-sky-900 transition"
                          >
                            Update Profile
                          </Link>
                        </div>
                              ...
                              {certifications.length > 0 ? (
                                certifications.map((cert) => (
                                  <div
                                    ...
                                    className="flex border-b border-zinc-200 py-2 justify-between hover:cursor-pointer"
                                  >
