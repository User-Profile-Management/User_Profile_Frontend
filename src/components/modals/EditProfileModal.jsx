...
const EditProfileModal = ({ isOpen, onClose, onSave, userData }) => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        if (!profileData.address || !profileData.phone || !profileData.emergencyContact) {
                    ...
                    <div className="flex items-center">
                        ...
                        <div className="w-2/3 relative">
                            ...
                            <label 
                                ...
                                <img src={CertificateIcon} alt="Profile" className="w-5 h-5 mr-2" /> 
                                {profileData.profilePicture ? profileData.profilePicture.name : "Choose file"}
                            </label>
                        </div>
                    </div>
