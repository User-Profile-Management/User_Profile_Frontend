...
const DeleteProjectModal = ({ isOpen, onClose, onDelete }) => {
    ...
    return (
        <div className="fixed inset-0 z-5 bg-black bg-opacity-50 flex items-center justify-center">
            <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-[400px]">
                ...
                <p className="text-gray-600 text-center mt-2">This project will be permanently deleted.</p>
